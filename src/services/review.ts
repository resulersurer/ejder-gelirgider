...
export type ReviewItem = { id: string; bank: string; amount: number; currency: string; direction: "IN" | "OUT"; transactionDate: Date; sender: string | null; receiver: string | null; description: string | null; emailSubject: string; emailSender: string; confidenceScore: number; category: string | null };
